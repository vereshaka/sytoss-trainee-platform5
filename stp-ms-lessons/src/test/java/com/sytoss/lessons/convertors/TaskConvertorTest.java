...
public class TaskConvertorTest extends AbstractJunitTest {
    ...
    @Spy
    private TaskConvertor taskConvertor = new TaskConvertor(new TaskDomainConvertor(new DisciplineConvertor(new TeacherConvertor())), new TopicConvertor(new DisciplineConvertor(new TeacherConvertor())));
